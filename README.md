...
- **Cartes d'exercice repliées par défaut** : but, objectifs, consignes et schéma associé étaient toujours affichés en entier, ce qui limitait la grille à 3-4 exercices visibles à l'écran. Une carte ne montre plus par défaut que le nom, la catégorie et la durée ; un bouton « ▾ Détails » déplie le reste au clic (avec, à l'intérieur, les consignes longues toujours tronquées à 5 lignes avec « Lire la suite »). Résultat : deux fois plus d'exercices visibles sans défiler.
