...
- **Consignes repliées sur 5 lignes dans la bibliothèque** : un exercice avec un texte de consignes long allongeait toute la carte et rendait la grille difficile à parcourir. Le texte est maintenant tronqué avec un bouton « Lire la suite » qui le déplie au clic (le bouton n'apparaît que si le texte dépasse réellement 5 lignes).
